          ...
          {cart ? (
            <>
              ...
              <div className="textChoose font-medium text-opacity">
                ...
                generadores de Lorem Ipsum que se encuentran en Internet tienden
                a repetir trozos predefinidos cuando sea necesario, haciendo a
                este el único generador verdadero (válido) en la Internet.
              </div>
            ...
            <>
              ...
              <form action="https://checkout.wompi.co/p/" method="GET">
                ...
                <input type="hidden" name="reference" value="EKBVNUBNE867" />
